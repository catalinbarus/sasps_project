...
@Component({
  selector: 'app-board-admin-trailers-list',
  templateUrl: './board-admin-trailers-list.component.html',
  styleUrls: ['./board-admin-trailers-list.component.css']
})
export class BoardAdminTrailersListComponent {
