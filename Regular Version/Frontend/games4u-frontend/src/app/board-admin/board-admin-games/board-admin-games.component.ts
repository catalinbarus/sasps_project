...
@Component({
  selector: 'app-board-admin-games',
  templateUrl: './board-admin-games.component.html',
  styleUrls: ['./board-admin-games.component.css']
})
export class BoardAdminGamesComponent implements OnInit {
  ...
  onNewGame() {
    this.router.navigate(['edit_video_game'], { relativeTo: this.route });
  }
