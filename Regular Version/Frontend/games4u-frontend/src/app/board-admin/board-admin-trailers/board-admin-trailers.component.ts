...
@Component({
  selector: 'app-board-admin-trailers',
  templateUrl: './board-admin-trailers.component.html',
  styleUrls: ['./board-admin-trailers.component.css']
})
export class BoardAdminTrailersComponent implements OnInit {
